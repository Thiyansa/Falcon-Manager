...
MENU_URL="https://raw.githubusercontent.com/Thiyansa/Falcon-Manager/refs/heads/main/main/menu.sh"
SSHD_URL="https://raw.githubusercontent.com/Thiyansa/Falcon-Manager/refs/heads/main/main/ssh"
...
download_file() {
    ...
    if command -v curl > /dev/null; then
        curl -sL "$url" | tr -d '\r' > "$dest"
    elif command -v wget > /dev/null; then
        wget -qO- "$url" | tr -d '\r' > "$dest"
    else
